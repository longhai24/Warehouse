    ...
    $('#paging').paging({
        ...
        callBack: function (now) {
            ...
            for (var i = 0; i < currentPages; i++) {
                ...
                var create_dl = $('<dl></dl>');
                var _html = '<dt>' +
                    '<a href=' + 'vote?src=enterVote&vpid=' + books[num].id + ' target="_blank"><img src=' + books[num].image + '></a>' +
                    '</dt>' +
                    '<dd>' +
                    '<a href=' + 'vote?src=enterVote&vpid=' + books[num].id + ' target="_blank" class="title">' + books[num].title + '</a>' +
